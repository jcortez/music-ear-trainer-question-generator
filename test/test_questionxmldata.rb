...
class TestQuestionXMLData < Test::Unit::TestCase
  ...
  def test_write_question_data_xml
    questions = [
      QuestionGenerator::Question.new("test1.midi", QuestionGenerator::Chord.new(:c, :maj, :root_pos)),
      QuestionGenerator::Question.new("test2.midi", QuestionGenerator::Chord.new(:d, :min_maj_seventh, :first_inv)),
      QuestionGenerator::Question.new("test3.midi", QuestionGenerator::Chord.new(:g_sharp_a_flat, :maj, :root_pos)),
      QuestionGenerator::Question.new("test4.midi", QuestionGenerator::Chord.new(:f, :dom_seventh, :third_inv))
    ]
